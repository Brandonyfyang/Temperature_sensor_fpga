...
HD_PWD='D:/Digital/gra_design_xxw/gra_design_xxw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ds18_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ds18_top.tcl
