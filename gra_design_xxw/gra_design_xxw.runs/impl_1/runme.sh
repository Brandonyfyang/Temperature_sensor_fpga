...
HD_PWD='D:/Digital/gra_design_xxw/gra_design_xxw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ds18_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ds18_top.tcl -notrace
